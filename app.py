...
# 연간계획: O열 값이 없거나 0이면 확정값 352,553,515 MJ 사용
_연간_raw = float(_n2p_연간_raw) / 1000 if _n2p_연간_raw else None
개발량_연간 = _연간_raw if (_연간_raw and _연간_raw > 0) else 352553.515
